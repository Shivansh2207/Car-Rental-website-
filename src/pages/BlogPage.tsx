            ...
            <SectionReveal key={post.slug} delay={i * 0.07}>
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <span className="absolute left-4 top-4 inline-flex rounded-full bg-soft-white/90 px-3 py-1 text-xs font-semibold text-graphite-700 backdrop-blur-sm">
                    {post.category}
                  </span>
                </div>
    ...
    <>
      ...
      <section className="section-py bg-soft-white">
        <div className="container-px mx-auto max-w-3xl">
          ...
          <span className="inline-flex rounded-full bg-accent/10 px-3 py-1 text-xs font-semibold text-accent">{post.category}</span>
